...
include_once "../functions/updateAttendancefxn.php";

$h1 = isLoggedIn();
$details = retrieve_dets($h1);
?>
<?php
include_once "../settings/core.php";
        ...
        <main>
            ...
            <div class="container">
                ...
                <form action="../action/attendance_action.php" id=attend method="post">
                    ...
                    <input type="time" id="clockIn" name="clockIn" value="<?php echo $details['ClockInTime'] ?>" readonly>
                    ...
                    <input type="date" id="workingDate" name="workingDate" value="<?php echo $details['WorkingDate'] ?>" readonly>
